...
public class HomeWork {
	...
	public static void radioButtonTest() throws InterruptedException {
	...
	for(WebElement singleRadio: radioButtons) {
		...
		if(singleRadio.isDisplayed() && singleRadio.isEnabled()) {
			...
			System.out.println("Somthing is not right .Either is not displayed nor disapled");
		}
		
		Thread.sleep(1000);
	// check if it's selected.
		
		System.out.println("Is radio button sleceted" + singleRadio.isSelected());
	}
